                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="cards">
                                    <a href="videopage.php">
                                        <center><img class="b-lazy img-responsive" id="fadein" style="width:250px; height: 220px;" src="https://drive.google.com/uc?export=download&id=1rUtDCxkbvBXGHRI1R7YccMmZiGQSt6Na" alt="Basci of C">
                                            <div class="overlay">
                                                <div class="text01">
                                                    <ul>Basic of C
                                                        <li>keywords</l>
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="cards">
                                    <a href="videopage.php">
                                        <center><img class="b-lazy img-responsive" style="width:250px; height: 220px;" src="https://drive.google.com/uc?export=download&id=1WhpsRZWpQgGtNPpGIapa6T_efbhb-_w1" alt="">
                                            <div class="overlay">
                                                <div class="text01">
                                ...
                                <div class="cards">
                                    <a href="videopage.php">
                                        <center>
                                            ...
                                            <img class="b-lazy img-responsive" style="width:250px; height: 220px;" src="https://drive.google.com/uc?export=download&id=1VZe_l0PrgmmlJA-x5FW-hk5jGHOBOru0" alt=""></center>
                                ...
                                <div class="cards">
                                    <a href="videopage.php">
                                        <center>
                                            ...
                                            <img class="b-lazy img-responsive" style="width:250px; height: 220px;" src="https://drive.google.com/uc?export=download&id=10wQiIvmHDtQZs9lWfVNcKtbE8ivTIzWA" alt=""></center>
                                ...
                                <div class="cards">
                                    <a href="videopage.php">
                                        <center>
                                            ...
                                            </div><img class="b-lazy img-responsive" style="width:250px; height: 220px;" src="https://drive.google.com/uc?export=download&id=1QpbuhNsEe5KXwuoINKK03_H1k8cqWyj7" alt=""></center>
